...
class TestAstralTimeManager(unittest.TestCase):
    ...
    def test_cast_time_to_minute(self):
        tz = get_localzone()

        self.assertEqual(
            AstralTimesManager.cast_time_to_minute(datetime(2022, 3, 19, 9, 55, 15, tzinfo=tz)),
            datetime(2022, 3, 19, 9, 55, 0, tzinfo=tz)
        )
        self.assertEqual(
            AstralTimesManager.cast_time_to_minute(datetime(2022, 3, 19, 9, 55, 31, 12345, tzinfo=tz)),
            datetime(2022, 3, 19, 9, 55, 0, tzinfo=tz)
        )
    ...
    def test_get_astral_times(self):
        ...
        expected_times = {
            ...
            "dawnNautical": datetime(2022, 3, 19, 4, 15, tzinfo=timezone(timedelta(seconds=3600))),
            "dawnCivil": datetime(2022, 3, 19, 5, 34, tzinfo=timezone(timedelta(seconds=3600))),
            "sunrise": datetime(2022, 3, 19, 6, 8, tzinfo=timezone(timedelta(seconds=3600))),
            "noon": datetime(2022, 3, 19, 12, 12, tzinfo=timezone(timedelta(seconds=3600))),
            "sunset": datetime(2022, 3, 19, 18, 18, tzinfo=timezone(timedelta(seconds=3600))),
            "duskCivil": datetime(2022, 3, 19, 18, 51, tzinfo=timezone(timedelta(seconds=3600))),
            "duskNautical": datetime(2022, 3, 19, 20, 11, tzinfo=timezone(timedelta(seconds=3600))),
            "duskAstro": datetime(2022, 3, 19, 19, 30, tzinfo=timezone(timedelta(seconds=3600))),
            "midnight": datetime(2022, 3, 19, 0, 12, tzinfo=timezone(timedelta(seconds=3600)))
        }
    ...
    def test_get_astral_times_invalid(self):
        ...
        expected_times = {
            'dawnAstro': datetime(2022, 6, 21, 1, 45, tzinfo=timezone(timedelta(seconds=3600))),
            'dawnCivil': datetime(2022, 6, 21, 2, 59, tzinfo=timezone(timedelta(seconds=3600))),
            'dawnNautical': None,
            'duskAstro': datetime(2022, 6, 21, 22, 27, tzinfo=timezone(timedelta(seconds=3600))),
            'duskCivil': datetime(2022, 6, 21, 21, 14, tzinfo=timezone(timedelta(seconds=3600))),
            'duskNautical': None,
            'midnight': datetime(2022, 6, 21, 0, 6, tzinfo=timezone(timedelta(seconds=3600))),
            'noon': datetime(2022, 6, 21, 12, 6, tzinfo=timezone(timedelta(seconds=3600))),
        ...
        self.assertEqual(expected_times, astral_times)
    ...
    def test_get_astral_times_extented_invalid(self):
        ...
        self.assertEqual({
            ...
            'dawn11': datetime(2022, 6, 21, 3, 0, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn12': datetime(2022, 6, 21, 2, 45, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn13': datetime(2022, 6, 21, 2, 28, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn14': datetime(2022, 6, 21, 2, 5, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn15': datetime(2022, 6, 21, 1, 26, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn16': None,
            'dawn17': None,
            'dawn18': None,
            'dawn2': datetime(2022, 6, 21, 4, 35, tzinfo=timezone(timedelta(seconds=7200))),
            ...
            'dawn5': datetime(2022, 6, 21, 4, 8, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn6': datetime(2022, 6, 21, 3, 59, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn7': datetime(2022, 6, 21, 3, 48, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn8': datetime(2022, 6, 21, 3, 38, tzinfo=timezone(timedelta(seconds=7200))),
            'dawn9': datetime(2022, 6, 21, 3, 26, tzinfo=timezone(timedelta(seconds=7200))),
            'dawnAstro': datetime(2022, 6, 21, 2, 45, tzinfo=timezone(timedelta(seconds=7200))),
            ...
            'dusk11': datetime(2022, 6, 21, 23, 12, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk12': datetime(2022, 6, 21, 23, 27, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk13': datetime(2022, 6, 21, 23, 45, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk14': datetime(2022, 6, 22, 0, 7, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk15': datetime(2022, 6, 22, 0, 46, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk16': None,
            'dusk17': None,
            'dusk18': None,
            'dusk2': datetime(2022, 6, 21, 21, 37, tzinfo=timezone(timedelta(seconds=7200))),
            ...
            'dusk5': datetime(2022, 6, 21, 22, 4, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk6': datetime(2022, 6, 21, 22, 14, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk7': datetime(2022, 6, 21, 22, 24, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk8': datetime(2022, 6, 21, 22, 35, tzinfo=timezone(timedelta(seconds=7200))),
            'dusk9': datetime(2022, 6, 21, 22, 46, tzinfo=timezone(timedelta(seconds=7200))),
            'duskAstro': datetime(2022, 6, 21, 23, 27, tzinfo=timezone(timedelta(seconds=7200))),
            'duskCivil': datetime(2022, 6, 21, 22, 14, tzinfo=timezone(timedelta(seconds=7200))),
            'duskNautical': None,
            'midnight': datetime(2022, 6, 21, 1, 6, tzinfo=timezone(timedelta(seconds=7200))),
            'noon': datetime(2022, 6, 21, 13, 6, tzinfo=timezone(timedelta(seconds=7200))),
